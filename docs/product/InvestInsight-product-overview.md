...
当前主界面文案已先向 2.0 设计稿靠拢：顶部入口使用“总览工作台”，子页面使用“总览、板块机会、策略跟踪”，并保留“AI 助手”和“配置中心”入口。总览页的市场仪表盘、关键机会、持仓摘要和 AI 摘要已经开始沉淀为独立 `DashboardRenderer`，后续会继续把这些页面从 `MainWindow.cpp` 拆成 renderer/panel。
