...
3. `docs/versions/README.md`：快速查看每个版本的简易更新点。
4. 本文档：确认版本文档和发布文档的位置。
...
| `docs/versions/` | 按版本归档的设计稿、规格、实施计划、截图素材、发布说明和版本总览。 |
...
| `docs/versions/v2.2/` | 2.2 UI 内容可读性优化计划，聚焦 AI 协同分析、事件证据链、理由去重、板块机会表格和截图验证。 |
| `docs/versions/v2.3/` | 2.3 推荐生命周期与信任机制计划，聚焦反追高、回调观察、风险预警和信号复盘。 |
| `docs/versions/v2.4/` | 2.4 技术点位与多周期推荐模型计划及第一轮实现，聚焦支撑阻力、买入观察区、止盈减仓区和几个月维度的推荐判断。 |
| `docs/versions/v2.5/` | 2.5 DESIGN.md 新界面设计系统，聚焦投研工作台视觉语言、页面重排和多页面 SVG 设计稿。 |
